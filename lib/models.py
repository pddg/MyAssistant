...
class Info(Base):
    ...
    def __repr__(self):
        return "<Info('{0}','{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{7}', '{8}')>".format(self.subject, self.teacher, self.week, self.period,
...
class Cancel(Base):
    ...
    def __repr__(self):
        return "<Cancel('{0}','{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{6}')>".format(self.subject, self.teacher, self.day, self.week,
...
class News(Base):
    ...
    def __repr__(self):
        return "<News('{0}', '{1}', '{2}', '{3}')>".format(self.up_date, self.detail, self.link, self.active)
